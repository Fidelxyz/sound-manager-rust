...
export declare type DataTablePassThroughOptionType =
  | DataTablePassThroughAttributes
  | ((
      options: DataTablePassThroughMethodOptions,
    ) => DataTablePassThroughAttributes | string)
  | string
  | null
  | undefined;

export declare type DataTablePassThroughTransitionType =
  | TransitionProps
  | ((options: DataTablePassThroughMethodOptions) => TransitionProps)
  | undefined;
 ...
 */
export interface DataTableCellEditCancelEvent
  extends DataTableCellEditInitEvent {}
 ...
 */
export interface DataTableRowEditSaveEvent<T = any>
  extends DataTableRowEditInitEvent<T> {}
 ...
 */
export interface DataTableRowEditCancelEvent<T = any>
  extends DataTableRowEditInitEvent<T> {}
